...
public class Auth {                                //создание класса "Аутентификация"
    ...
    public void signIn() throws WrongLoginException {                         //создание метода "войти" с вызовом обработки исключения

        System.out.println("Для входа на сайте введите Логин.");              //вывод сообщения о логине
        String login = scanScan.nextLine();                                   //создание переменной ввода строки и запрос ввода логина
        System.out.println("Введите Пароль.");                                //вывод сообщения о пароле
        String password = scanScan.nextLine();                                //создание переменной ввода строки и запрос ввода пароля
        if (login.equals(getLogin()) && password.equals(getPassword())) {     //создание условия и проверка логина и пароля
            System.out.println("Вход на сайт выполнен успешно!");             //вывод сообщения о успешном вводе пароля и регистрации
        } else {                                                              //создание действий при отрицательной проверке
            System.out.println("Внимание! Логин или Пароль введены неверно.");//вывод сообщения о неправильном пароле
            throw new WrongLoginException ();                                 //вызов метода обработки исключения
        }
    }
